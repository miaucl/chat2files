"""Client for the calculator tool using Haystack MCP integration."""
import logging
...
TOOL = DIR / "calculator-tool-stdio.py"
...
server_info_stdio = StdioServerInfo(command="python", args=[str(TOOL)])
...
user_input = "Please add 7 and 9 and then subtract 12."
...
pipeline.draw(str(DIR / "calculator-client.png"))
